...
namespace ClashofClans.Core.Network
{
	public class NettyService
	{
		...
		public async Task RunServerAsync()
		{
			...
			ServerBootstrap.Option(ChannelOption.SoBacklog, 100).Option(ChannelOption.TcpNodelay, true).Option(ChannelOption.SoKeepalive, true).Handler(new LoggingHandler("SRV-ICR"))
			...
			IPEndPoint endpoint = (IPEndPoint)ServerChannel.LocalAddress;
